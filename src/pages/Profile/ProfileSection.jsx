      ...
      <div className="upperProfile">
        {progress == true && data.ProfileDetails == undefined ? (
          ...
          <div className="backgroundImage">
            ...
            <img
              src={
                data.ProfileDetails && data.ProfileDetails.backgroundImg
                  ? data.ProfileDetails.backgroundImg
                  : ""
              }
            />
            ...
            <div className="subImage">
              <Avatar
                src={
                  data.ProfileDetails && data.ProfileDetails.profileImg
        ...
        <div className="informationBox">
          <div className="profileName">
            ...
            <h4 className="subProfilenName fontProfile">
              {data.ProfileDetails && data.ProfileDetails.username
          ...
          <div className="bioSection">
            <p className="bio fontProfile">
              {data.ProfileDetails && data.ProfileDetails.bio
          ...
          <div className="userPersonalSection">
            <Icon
              Icon={LocationOnIcon}
              label={
                data.ProfileDetails && data.ProfileDetails.location
                  ? data.ProfileDetails.location
                  : "Loading ..."
              }
              idx={0}
            />
            <Icon
              ...
              label={
                data.ProfileDetails && data.ProfileDetails.work
                  ? data.ProfileDetails.work
                  : "Loading ..."
              }
              idx={1}
            />
            <Icon
              Icon={StarIcon}
              label={
                data.ProfileDetails && data.ProfileDetails.favourite
                  ? data.ProfileDetails.favourite
                  : "Loading ..."
              }
              idx={2}
            />
            <Icon
              ...
              label={`${getJoinedDate(data.joinedDate)}`}
              idx={3}
            />
          </div>
          ...
          <div className="userDataSection fontProfile ">
            <div className="dataDesign">
              <span className="dataDesignNo">
                <h3>
                  {data && data.ProfileDetails
                    ? data.ProfileDetails.post < postCount.ProfileDetails.post
                      ? postCount.ProfileDetails.post
